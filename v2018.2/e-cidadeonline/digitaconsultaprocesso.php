...
$sSqlDbMenuPref .= "    where m_arquivo = 'digitaconsultaprocesso.php' ";
...
function js_num_processo() {
  ...
  var numproc = document.form1.numeroprocesso.value;

  if (codproc == "" && numproc == "" || isNaN(codproc)) {
 ...
 if($linhas!=0){
  ...
  <tr height="100">
   <td align="center" class="green">
    ...
    <a href="digitaconsultaprocesso.php?outro='outro processo 2'">:: Pesquisar Outro Processo ::</a>
   </td>
  </tr>
  </table>
  <?
 ...
 <form name="form1" method="post" <?=$onsubmit?> action="pro3_conspro002.php">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="texto">
    ...
    <tr>
      ...
      <td width="50%" height="30">
        <input type="text" id="numeroprocesso" name="numeroprocesso" class="digitacgccpf" size="10">
      </td>
    </tr>
    <tr>
      <td width="50%" height="30" align="right">
...
if (isset($erroscripts)) {
  ...
  echo "  location='digitaconsultaprocesso.php'; \n";
  echo "</script> \n";
}
?>
<script>
