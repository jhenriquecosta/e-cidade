...
if (isset($outro)) {
 ...
 echo"<script>location.href='digitaconsultahabitacao.php'</script>";
}
...
$sSqlDbMenuPref .= "    where m_arquivo = 'digitaconsultahabitacao.php' ";
...
if (isset($id_usuario) && !empty($id_usuario)) {
 ...
 if($linhas!=0){
  ...
  //mostra encontrados
  ?>
   <a href="digitaconsultahabitacao.php?outro='outro processo'">:: Pesquisar Outro Processo ::</a><br><br>
  ...
  <tr height="100">
   <td align="center" class="green">
    ...
    <a href="digitaconsultahabitacao.php?outro='outro processo 2'">:: Pesquisar Outro Processo ::</a>
   </td>
  </tr>
  </table>
  <?
...
if (isset($erroscripts)) {
  ...
  echo "  location='digitaconsultahabitacao.php'; \n";
  echo "</script> \n";
}
?>
<script>
