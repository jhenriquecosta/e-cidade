...
//for($i=0;$i<$clquery->numrows;$i++){
 ...
 // db_fieldsmemory($clquery->result,$i);
  ...
  $pdf->setX(5);
  $pdf->Cell(284,8,"COMPETÊNCIA: ".$mesx."/".$q20_ano."                PLANILHA DE RETENÇÃO NUMERO: ".$planilha,"LBR",1,"C",1);
  $pdf->Image('imagens/files/logo_boleto.png',7,($yy+1),12);
  $pdf->SetFillColor(220,220,220);
  $pdf->setX(5);
  $pdf->Cell(284,6,"DADOS DO TOMADOR DE SERVIÇO",1,1,"C",1);
  $pdf->setX(5);
  $pdf->Cell(160,6,"NOME OU RAZÃO SOCIAL: ".$z01_nome,"LT",0,"L",0);
  $pdf->Cell(124,6,"INSCRIÇÃO MUNICIPAL: ".@$q20_inscr,"TR",1,"L",0);
  $pdf->setX(5);
  $pdf->Cell(160,6,"FONE: ".$q20_fonecontri,"LB",0,"L",0);
  $pdf->Cell(124,6,"CONTATO: ".$q20_nomecontri,"RB",1,"L",0);
  $pdf->SetFont('arial','B',10);
  $pdf->setX(5);
  $pdf->Cell(284,6,"DADOS DO PRESTADOR DE SERVIÇO",1,1,"C",1);
  $pdf->setX(5);
  $pdf->SetFont('arial','B',10);
  db_fieldsmemory($clquery->result,0);
  $pdf->Cell(160,6,"NOME OU RAZÃO SOCIAL: ".$q21_nome,"LT",0,"L",0);
  $pdf->Cell(124,6,"CNPJ OU CPF: ".$q21_cnpj,"TR",1,"L",0);
  $pdf->setX(5);
  $pdf->Cell(160,6,"SERVIÇO PRESTAFO: ".$q21_servico,"LB",0,"L",0);
  $pdf->Cell(124,6,"INSCRIÇÃO MUNICIPAL: ".$q21_inscr,"RB",1,"L",0);
  
  $pdf->setX(5);
  $pdf->Cell(57,5,"NOTA ",1,0,"C",1);
  $pdf->Cell(57,5,"SÉRIE",1,0,"C",1);
  $pdf->Cell(57,5,"VALOR DO SERVIÇO",1,0,"C",1);
