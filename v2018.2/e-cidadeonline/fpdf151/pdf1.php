...
if(file_exists("imagens/files/{$logo}")) {
	
	$this->Image("imagens/files/{$logo}", $posini, 8, 24);
	
} else {
	
  $this->Image("imagens/files/logo_boleto.png",$posini,8,24);
...
//Page footer
  ...
  global $url;
    ...
    $this->Cell(0,10,$url.'   '.$nome.'   Emissor: '.@$GLOBALS["DB_login"].'   Exercício: '.db_getsession("DB_anousu").'   Data: '.date("d-m-Y",db_getsession("DB_datausu"))." - ".date("H:i:s"),"T",0,'L');
