...
include(modification("classes/db_avalfreqres_classe.php"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
   <br>
   <center>
   <fieldset style="width:95%"><legend><b>Períodos para o cálculo de percentual de frequência do Resultado <?=$ed42_c_descr?></b></legend>
    <?php include(modification("forms/db_frmavalfreqres.php"));?>
   </fieldset>
   </center>
  </td>
 </tr>
...
if(isset($incluir)){
 if($clavalfreqres->erro_status=="0"){
  ...
  ?>
   <script>
    parent.iframe_c1.location="edu1_procresultado002.php?chavepesquisa=<?=$ed67_i_procresultado?>&forma=<?=$forma?>&possuiTurmasEncerradas=<?=$sPossuiTurmasEncerradas?>";
   </script>
  <?php
...
if(isset($cancelar)){
 echo "<script>location.href='".$clavalfreqres->pagina_retorno."&possuiTurmasEncerradas={$sPossuiTurmasEncerradas}'</script>";
}
