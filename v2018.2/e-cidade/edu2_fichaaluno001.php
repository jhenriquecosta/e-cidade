...
<br>
<center>
<fieldset style="width:95%"><legend><b>Relatório Ficha do Aluno</b></legend>
   ...
   if(isset($pesquisar)){
    ...
    <fieldset style="width:95%;"><legend><b>Filtros</b></legend>
     <table>
      <tr>
       <td valign="top">
        <input type="checkbox" id="imp_matricula" value="" checked> Mostrar informações de Matrículas<br>
        <input type="checkbox" id="imp_historico" value="" checked> Mostrar informações de Histórico<br>
        <input type="checkbox" id="imp_movimentacao" value="" checked> Mostrar informações de Movimentações<br>
       </td>
      </tr>
     </table>
    </fieldset>
