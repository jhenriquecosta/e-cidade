...
if ( !empty($_GET['possuiTurmasEncerradas']) ) {
  $possuiTurmasEncerradas = $_GET['possuiTurmasEncerradas'];
}
 ...
 <tr>
  <td align="left" valign="top" bgcolor="#CCCCCC">
   ...
   <fieldset style="width:95%"><legend><b>Elementos para o cálculo de aproveitamento do Resultado <?=$ed42_c_descr?></b></legend>
    <?php include(modification("forms/db_frmavalcompoeres.php")); ?>
   </fieldset>
   </center>
  </td>
 </tr>
...
if (isset($excluir)) {
  ...
  if($clavalcompoeres->erro_status=="0"){
    ...
    if (Elementos($ed44_i_procresultado)==0) {
      ...
      ?>
      <script>
        var sUrl  = 'edu1_procresultado002.php?chavepesquisa=<?=$ed44_i_procresultado?>&forma=<?=$forma?>';
            sUrl += '&possuiTurmasEncerradas=<?=$possuiTurmasEncerradas?>';
