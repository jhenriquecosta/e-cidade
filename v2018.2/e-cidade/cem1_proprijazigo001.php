...
require_once(modification("classes/db_proprijazigo_classe.php"));
...
if(isset($incluir)){
  ...
  db_inicio_transacao();
    $clproprijazigo->incluir("");
  db_fim_transacao();
}

define("ARQUIVO_MENSAGEM_JAZIGO001", "tributario.cemiterio.cem1_proprijazigo001.");
...
if(isset($incluir)){
  ...
  if($clproprijazigo->erro_status=="0"){
    ...
    db_msgbox( _M( ARQUIVO_MENSAGEM_JAZIGO001 . "jazigo_incluido") );

    echo "<script>";
    echo " parent.document.formaba.a2.disabled=false; ";
    echo " (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_a2.location.href='cem1_proprijazigo002.php?cm28_i_codigo=$cm28_i_codigo&cm28_i_ossoariojazigo=$cm28_i_ossoariojazigo&cm28_i_proprietario=$cm28_i_proprietario&z01_nome=$z01_nome&chavepesquisa=$cm28_i_codigo';";
