...
<div class="container">
     ...
     <form name="form1" method="post">
      <fieldset><legend><b>Relatório Histórico Escolar</b></legend>
       <table>
        <tr>
           <td colspan="2">
             <table style="display: <?php echo $sDisplayTable;?>;"><!--Inicio tabela selects escola filtro-->
               ...
               <tr>
                <td colspan='3'>
                 ...
                 <td>
                   <select id="tipoaluno" name="tipoaluno" onchange="js_alunoshist(document.form1.escola.value,this.value);">
               ...
               <tr>
                 <td  colspan='3'>
                   <label for="cboAno"> <b>Último Ano Cursado:</b> </label>
                 </td>
                 <td>
                   <select id="cboAno">
        ...
        <tr style="display: <?php echo $sDisplayRow;?>;">
          <td style="width:450px;">
              <b>Alunos com registro de Histórico:</b><br>
       ...
       <tr>
        ...
        <tr>
         <td nowrap colspan= '2'>
          <label for="tipohistorico" ><b>Tipo do Modelo:</b></label>
         </td>
         <td>
          <select name="tipohistorico" id="tipohistorico" Onchange = "js_Orientacao();">
         </select>
        </td>
       </tr>
       <tr id='trEtapasLancadas' style='display: none'>
        <td colspan='2'>
          <label for="etapasLancadas"> <b>Exibir Etapas:</b> </label>
        </td>
        <td>
          <select id="etapasLancadas">
       ...
       <tr>
        <td nowrap colspan= '2'>
         ...
         <select name="tiporegistro" id="tiporegistro" >
          ...
          <option value='U'>Listar Último Registro</option>
         </select>
        </td>
       </tr>
       ...
       <tr>
         <td nowrap colspan= '2'>
          <label for="select_diretor"><b>Diretor:</b></label>
         </td>
         <td>
          <select id="select_diretor" name="select_diretor" >
          </select>
         </td>
        </tr>
        <tr>
         <td nowrap colspan= '2'>
          <label for="select_secretario"><b>Secretário:</b></label>
         </td>
         <td>
          <select id="select_secretario" name="select_secretario" >
          </select>
         </td>
        </tr>
        </table> <!--fecha table-->
     ...
     <div id= 'div'>
      <h4 align= 'left'>Disposições do Cabeçalho</h4>
       1 - Neste modelo o sistema posicionará as informações lado a lado na seguinte ordem :
           Brasão da República Federativa do Brasil ou logotipo do município, texto inserido no campo cabeçalho
       ...
       2 - Neste modelo o sistema posicionará as informações centralizadas uma abaixo da outra:
           Brasão da República Federativa do Brasil ou logotipo do município e texto inserido no campo cabeçalho no topo do
...
$('tipohistorico').addClassName('field-size9');
$('disposicao').addClassName('field-size9');
$('tiporegistro').addClassName('field-size9');
$('exibir_reclassificacao').addClassName('field-size9');
$('select_diretor').addClassName('field-size9');
$('select_secretario').addClassName('field-size9');
