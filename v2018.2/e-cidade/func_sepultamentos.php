        ...
        <td height="63" align="center" valign="top">
          <table width="35%" border="0" align="center" cellspacing="0">
            <form name="form2" method="post" action="">
              <tr>
                <td width="4%" align="right" nowrap title="<?php echo $Tcm01_i_codigo; ?>">
                  <?php echo $Lcm01_i_codigo; ?>
                </td>
              ...
              <tr>
                ...
                <td width="96%" align="left" nowrap title="<?php echo $Tz01_nome; ?>">
                  <?php
            ...
            if(!isset($pesquisa_chave)) {
              ...
              if(isset($campos) == false) {
                ...
                if(file_exists("funcoes/db_func_sepultamentos.php") == true) {
                  include(modification("funcoes/db_func_sepultamentos.php"));
                } else {

                  $campos  = " cm01_i_codigo,                               ";
                  $campos .= " cgm.z01_nome as z01_nome,                    ";
                  $campos .= " cm01_d_falecimento,                          ";
                  $campos .= " cm01_i_declarante,                           ";
                  $campos .= " cgm3.z01_nome as declarante,                 ";
                  $campos .= " cm01_i_hospital,                             ";
                  $campos .= " upper(case when cm01_i_hospital is not null  ";
                  $campos .= "         then cgm1.z01_nome                   ";
                  $campos .= "         else cm01_c_nomehospital             ";
                  $campos .= "       end) as hospital,                      ";
                  $campos .= " cm01_i_funeraria,                            ";
                  $campos .= " upper(case when cm01_i_funeraria is not null ";
                  $campos .= "         then cgm2.z01_nome                   ";
                  $campos .= "         else cm01_c_nomefuneraria            ";
                  $campos .= "       end) as funeraria                      ";
                }
              }
