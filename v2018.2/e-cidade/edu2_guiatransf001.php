...
include(modification("classes/db_transfescolafora_classe.php"));
include(modification("classes/db_escoladiretor_classe.php"));
include(modification("classes/db_obstransferencia_classe.php"));
...
function js_pesquisa(tipo) {
  ...
  if (tipo == "") {
    ...
    var oParametros = {
      ...
      'obs'          : $F('ed283_t_mensagem'),
      'bolsafamilia' : document.form1.ed283_c_bolsafamilia.value
    };

    var oRelatorio = new EmissaoRelatorio('edu2_guiatransf002.php', oParametros);
        oRelatorio.setMethod('get');
        oRelatorio.open();
  }
