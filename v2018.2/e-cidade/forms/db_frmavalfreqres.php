 ...
 <tr>
  <td nowrap >
   <table border="0" width="100%">
    ...
    <tr>
     <td colspan="2">
      <input type="hidden" name="procedimento" value="<?=$iProcedimento?>">
      <input type="hidden" name="forma" value="<?=$sForma?>">
...
function js_pesquisaed67_i_procavaliacao(mostra){
 ...
 if ( mostra==true ) {
  ...
  js_OpenJanelaIframe( '',
                       ...
                       'func_procavaliacaofreq.php?periodos=<?=$iPeriodo?>&procedimento=<?=$procedimento?>&funcao_js=parent.js_mostraprocavaliacao1|ed41_i_codigo|ed09_c_descr',
                       'Pesquisa de Avaliações Períodicas',
                       true,
                       0,
                       0,
                       770,
  ...
  if ( document.form1.ed67_i_procavaliacao.value != '' ) {
    ...
    js_OpenJanelaIframe( '',
                         'db_iframe_procavaliacao',
                         'func_procavaliacaofreq.php?periodos=<?=$iPeriodo?>&procedimento=<?=$procedimento?>&pesquisa_chave='+document.form1.ed67_i_procavaliacao.value+'&funcao_js=parent.js_mostraprocavaliacao',
                         'Pesquisa',
                         false);
  } else {
