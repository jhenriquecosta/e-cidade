    ...
    <table class="form-container">
      <tr>
        <td nowrap title="<?=$Ted29_i_codigo?>">
          <label for="ed29_i_codigo"><?=$Led29_i_codigo?></label>
        </td>
        <td>
          <?php db_input('ed29_i_codigo', 10, $Ied29_i_codigo, true, 'text', 3, "")?>
        </td>
      </tr>
      <tr>
        <td nowrap title="<?=$Ted29_c_descr?>">
          <label for="ed29_c_descr"><?=$Led29_c_descr?></label>
        </td>
        <td colspan= '3'>
          <?php db_input('ed29_c_descr', 50, $Ied29_c_descr, true, 'text', $db_opcao, "")?>
        </td>
      </tr>
      <tr>
        ...
        <td colspan= '3'>
          <?php
            db_input('ed29_i_ensino', 10, $Ied29_i_ensino, true, 'text', $db_opcao1, " onchange='js_pesquisaed29_i_ensino(false);'");
            db_input('ed10_c_descr', 36, $Ied10_c_descr, true, 'text', 3, '');
          ?>
       </td>
      </tr>
      <tr>
        <td nowrap title="<?=$Ted29_c_historico?>">
           <label for="ed29_c_historico"><?=$Led29_c_historico?></label>
        </td>
        <td>
          <?php
            $x = array('S'=>'SIM', 'N'=>'NÃO');
        ...
        <td nowrap title="<?=$Ted29_i_avalparcial?>">
          <label for="ed29_i_avalparcial"><?=$Led29_i_avalparcial?></label>
        </td>
        <td>
          <?php
...
function js_pesquisaed29_i_ensino(mostra) {
  ...
  if (mostra == true) {
    ...
    js_OpenJanelaIframe('', 'db_iframe_ensino', 'func_ensino.php?funcao_js=parent.js_mostraensino1|ed10_i_codigo|'+
    	                'ed10_c_descr', 'Pesquisa de Ensinos', true
    	               );
