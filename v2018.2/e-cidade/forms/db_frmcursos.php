...
$clrotulo->label('ed71_i_codigo');
$db_botao = false;
?>
<form class="container" name="form1" method="post" action="">
  <fieldset >
    <legend>Alteração de Curso</legend>
    <table class="form-container">
      ...
      <tr>
        <td nowrap title="<?=$Ted29_i_ensino?>">
          <label for="ed29_i_ensino"><?php db_ancora($Led29_i_ensino,"js_pesquisaed29_i_ensino(true);",3);?></label>
        </td>
        <td>
          <?php
...
function js_pesquisa() {
  ...
  var sUrl = 'func_cursoedu.php?funcao_js=parent.js_preenchepesquisa|ed29_i_codigo&soAtivo';
