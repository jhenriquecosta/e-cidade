...
{var oPreviousSearch=oSettings.oPreviousSearch;var sSearchStr=oSettings.oLanguage.sSearch;sSearchStr=(sSearchStr.indexOf('_INPUT_')!==-1)?sSearchStr.replace('_INPUT_','<input type="text" />'):sSearchStr===""?'<div class="input-append" style="margin-right:10px">'+' <input class="span4" type="text" placeholder="Informe o texto">'+' <button class="btn"><i class="icon-filter"></i> Filtrar</button>'+' <button class="btn clear"><i class="icon-remove"></i></button>'+'</div>':'<div class="input-append" style="margin-right:10px">'+sSearchStr+' <input class="span4" type="text" placeholder="Informe o texto">'+' <button class="btn"><i class="icon-filter"></i> Filtrar</button>'+' <button class="btn clear"><i class="icon-remove"></i></button>'+'</div>';var nFilter=document.createElement('div');nFilter.className=oSettings.oClasses.sFilter;nFilter.innerHTML='<label>'+sSearchStr+'</label>';if(!oSettings.aanFeatures.f)
{nFilter.id=oSettings.sTableId+'_filter';}
var jqFilter=$('input[type="text"]',nFilter);var jqFilterBtn=$('button',nFilter);var jqFilterBtnClear=$('button.clear',nFilter);nFilter._DT_Input=jqFilter[0];jqFilter.val(oPreviousSearch.sSearch.replace('"','&quot;'));jqFilter.bind('keyup.DT',function(e){if(e.keyCode!=13)
{return false;}
var n=oSettings.aanFeatures.f;var val=this.value===""?"":this.value;for(var i=0,iLen=n.length;i<iLen;i++)
{if(n[i]!=$(this).parents('div.dataTables_filter')[0])
{$(n[i]._DT_Input).val(val);}}
if(val!=oPreviousSearch.sSearch)
{_fnFilterComplete(oSettings,{"sSearch":val,"bRegex":oPreviousSearch.bRegex,"bSmart":oPreviousSearch.bSmart,"bCaseInsensitive":oPreviousSearch.bCaseInsensitive});}});jqFilter.attr('aria-controls',oSettings.sTableId)
jqFilterBtn.click(function(){var e=jQuery.Event("keyup");e.which=13;e.keyCode=13;jqFilter.trigger(e);});jqFilterBtnClear.click(function(){var e=jQuery.Event("keyup");e.which=13;e.keyCode=13;jqFilter.val('').trigger(e);});return nFilter;}
