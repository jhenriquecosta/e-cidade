    ...
    if ($('#s_dados_exigibilidadeiss').val() == '25') {
      ...
      if (servicoTributadoMunicipio.val() == 't') {
        ...
        if (naturezaOperacao.val() == '1') {
          ...
          //Regra do MEI/Sociedade de Profissionais e não incide
          if ($('#b_mei_sociedade_profissionais').val() != '1' && $('#s_nao_incide').val() != '1') {
    ...
    $.ajax({
      ...
      'success'  : function(data) {
        ...
        if (data.erro) {
          ...
          if (data.regime_tributario_fixado || data.regime_tributario_mei || data.regime_tributario_sociedade_profissionais || $('#s_dados_exigibilidadeiss').val() == '27') {
