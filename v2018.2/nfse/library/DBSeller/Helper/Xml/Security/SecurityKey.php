 ...
 */
  ...
  class DBSeller_Helper_Xml_Security_SecurityKey {
  ...
  public function __construct($type, $params=NULL) {
    ...
    switch ($type) {
      ...
      case (DBSeller_Helper_Xml_Security_SecurityKey::TRIPLEDES_CBC):
        ...
        break;
      case (DBSeller_Helper_Xml_Security_SecurityKey::AES128_CBC):
        ...
        break;
      case (DBSeller_Helper_Xml_Security_SecurityKey::AES192_CBC):
      ...
      case (DBSeller_Helper_Xml_Security_SecurityKey::AES256_CBC):
      ...
      case (DBSeller_Helper_Xml_Security_SecurityKey::RSA_1_5):
      ...
      case (DBSeller_Helper_Xml_Security_SecurityKey::RSA_OAEP_MGF1P):
        ...
        throw new Exception('Certificate "type" (private/public) must be passed via parameters');
        break;
      case (DBSeller_Helper_Xml_Security_SecurityKey::RSA_SHA1):
        ...
        throw new Exception('Certificate "type" (private/public) must be passed via parameters');
        break;
      case (DBSeller_Helper_Xml_Security_SecurityKey::RSA_SHA256):
        ...
        throw new Exception('Certificate "type" (private/public) must be passed via parameters');
        break;
      case (DBSeller_Helper_Xml_Security_SecurityKey::RSA_SHA384):
      ...
      case (DBSeller_Helper_Xml_Security_SecurityKey::RSA_SHA512):
  ...
  */
  ...
  public function generateSessionKey() {
    ...
    if ($this->type === DBSeller_Helper_Xml_Security_SecurityKey::TRIPLEDES_CBC) {
  ...
  static function convertRSA($modulus, $exponent) {
    ...
    $exponentEncoding       = DBSeller_Helper_Xml_Security_SecurityKey::makeAsnSegment(0x02, $exponent);
    $modulusEncoding        = DBSeller_Helper_Xml_Security_SecurityKey::makeAsnSegment(0x02, $modulus);
    $sequenceEncoding       = DBSeller_Helper_Xml_Security_SecurityKey:: makeAsnSegment(0x30, $modulusEncoding.$exponentEncoding);
    $bitstringEncoding      = DBSeller_Helper_Xml_Security_SecurityKey::makeAsnSegment(0x03, $sequenceEncoding);
    $rsaAlgorithmIdentifier = pack("H*", "300D06092A864886F70D0101010500");
    $publicKeyInfo          = DBSeller_Helper_Xml_Security_SecurityKey::makeAsnSegment (0x30, $rsaAlgorithmIdentifier.$bitstringEncoding);
