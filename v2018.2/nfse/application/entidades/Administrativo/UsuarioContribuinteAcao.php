...
class UsuarioContribuinteAcao {
     ...
     * @ManyToOne(targetEntity="UsuarioContribuinte", inversedBy="usuarios_contribuintes",cascade={"persist"})
     ...
     * @ManyToOne(targetEntity="Acao", inversedBy="acoes")
     ...
     */
    public function setUsuarioContribuinte(\Administrativo\UsuarioContribuinte $usuario_contribuinte) {
