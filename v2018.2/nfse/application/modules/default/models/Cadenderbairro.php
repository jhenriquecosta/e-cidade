...
/**
 * Classe para retornar dos bairros da prefeitura
 */
class Default_Model_Cadenderbairro extends WebService_Model_Ecidade {

  private static $aCampos = array('bairro', 'cod_bairro');
