...
/**
 * Modelo 1 para emissão dos relatórios no módulo fiscal.
 *
 * @tutorial O modelo não precisa que seja setado a orientação ele é auto ajustável.
 * @package  Fiscal/Model
 * @use      Fpdf2File (FPDF)
 */

/**
 * Class Fiscal_Model_Relatoriopdfmodelo1
 *
 * @package Fiscal/Model
 * @use     Fpdf2File (FPDF)
 */
class Fiscal_Model_Relatoriopdfmodelo1 extends Fpdf2File {
