 ...
 */
class Fiscal_Form_CancelamentoRejeitar extends Twitter_Bootstrap_Form_Vertical {
  ...
  public function init() {
    ...
    $this->setName('CancelamentoRejeitar');
    $this->setAction($oBaseUrlHelper->baseUrl('/fiscal/cancelamento-nfse/rejeitar'));

    $oElm = $this->createElement('hidden', 'id');
    $oElm->setValue($this->solicitacao['id']);
    $oElm->setRequired(TRUE);
    $this->addElement($oElm);

    $oElm = $this->createElement('textarea', 'justificativa_fiscal');
