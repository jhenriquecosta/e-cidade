 ...
 */
class Administrativo_Form_ProtocoloEnvioEmail extends Twitter_Bootstrap_Form_Vertical {
  ...
  public function init() {
    ...
    $this->setAction($oBaseUrlHelper->baseUrl('/administrativo/protocolo/enviar-email'));
