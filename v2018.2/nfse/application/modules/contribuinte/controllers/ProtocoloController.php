 ...
 *
 * Class Contribuinte_ProtocoloController
 * @package Contribuinte\Controllers\ProtocoloController
 * @author Luiz Marcelo Schmitt <luiz.marcelo@dbseller.com.br>
 */
class Contribuinte_ProtocoloController extends Contribuinte_Lib_Controller_AbstractController {
  ...
  public function consultaAction() {
    ...
    $oFormConsulta = new Contribuinte_Form_ProtocoloConsulta();
  ...
  public function consultaProcessarAction() {
    ...
    $oPaginatorAdapter = new DBSeller_Controller_Paginator(Contribuinte_Model_Protocolo::getQuery(),
        'Contribuinte_Model_Protocolo',
        'Contribuinte\Protocolo');
    ...
    $oPaginatorAdapter->andWhere("e.usuario = " . $oSessao->iUsuarioEscolhido);
  ...
  public function emailAction() {
    ...
    $oForm = new Contribuinte_Form_ProtocoloEnvioEmail();
  ...
  public function enviarEmailAction() {
    ...
    if (!$oForm->isValid($aParametros)) {
      ...
      try {
        ...
        $oProtocolo      = Contribuinte_Model_Protocolo::getByAttribute('id', $aParametros['id']);
  ...
  private function gerarPDF(Array $aDadosProtocolo) {
    ...
    $oFpdf = new Contribuinte_Model_RelatorioPdfModelo1('L');
