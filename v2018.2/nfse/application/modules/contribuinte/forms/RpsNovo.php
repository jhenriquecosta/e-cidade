...
class Contribuinte_Form_RpsNovo extends Twitter_Bootstrap_Form_Horizontal {
  ...
  public function init() {
    ...
    $this->setAction($this->oBaseUrlHelper->baseUrl('/contribuinte/rps-novo/emitir'));
    ...
    // Estado e municipio para tomadores do exterior
